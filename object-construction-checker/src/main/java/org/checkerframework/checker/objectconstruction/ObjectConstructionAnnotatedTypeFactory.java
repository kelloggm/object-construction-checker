...
public class ObjectConstructionAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
   ...
   * @param autoValueClassElement enclosing class
   * @param b whether this toBuilder was generated by Lombok or AutoValue
   */
  private void handleToBuilder(
      AnnotatedTypeMirror.AnnotatedExecutableType t, Element autoValueClassElement, BuilderKind b) {
    AnnotatedTypeMirror returnType = t.getReturnType();
    handleToBuilderType(returnType, autoValueClassElement, b);
  }
  ...
  private void handleToBuilderType(
      AnnotatedTypeMirror type, Element autoValueClassElement, BuilderKind b) {
    ...
    List<String> requiredProperties =
        getRequiredProperties(autoValueClassElement, allBuilderMethodNames, b);
