...
public class LombokSingularExample {
	...
	public static class LombokSingularExampleBuilder {
		...
		@java.lang.SuppressWarnings("all")
		@lombok.Generated
		public LombokSingularExampleBuilder items(final java.util.Collection<? extends Object> items) {
			if (this.items == null) this.items = new java.util.ArrayList<Object>();
		...
		public LombokSingularExample build() {
			...
			case 1: 
				...
				break;
			default: 
				items = java.util.Collections.unmodifiableList(new java.util.ArrayList<Object>(this.items));
			}
