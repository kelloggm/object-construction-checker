...
class CheckerFrameworkBuilder {
    ...
    public static void testOldCalledMethodsGood(@org.checkerframework.checker.mustcall.qual.CalledMethods({"y", "z"}) CheckerFrameworkBuilderBuilder pb) {
        pb.build();
    }

    public static void testOldCalledMethodsBad(@org.checkerframework.checker.mustcall.qual.CalledMethods({"y"}) CheckerFrameworkBuilderBuilder pb) {
