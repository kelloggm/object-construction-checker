...
public class LombokNoSingularButClearMethodExample {
	...
	public static class LombokNoSingularButClearMethodExampleBuilder {
		...
		@java.lang.SuppressWarnings("all")
		@lombok.Generated
		public LombokNoSingularButClearMethodExampleBuilder items(@lombok.NonNull final List<Object> items) {
			if (items == null) {
		...
		public java.lang.String toString() {
			return "LombokNoSingularButClearMethodExample.LombokNoSingularButClearMethodExampleBuilder(items=" + this.items + ")";
		}
	}
